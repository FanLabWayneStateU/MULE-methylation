...
my $screen_file = "MULE_gene/data/pack_MULE_candidate_$spe"."_jiang_repeatscout_new_tir_final5_new_no_transposase_e9_internal_seq_only_screen.out.gff_cover";
...
my $output = $genic_mule."_genic_non_auto_lineage_te_cov";
open(OUTPUT,">$output");
my $output1 = $genic_mule."_nongenic_non_auto_lineage_te_cov";

open(OUTPUT1,">$output1");
my $output2 = $genic_mule."_genic_non_auto_Asian_all_te_cov";

open(OUTPUT2,">$output2");
my $output3 = $genic_mule."_nongenic_non_auto_Asian_all_te_cov";
open(OUTPUT3,">$output3");

my $output4 = $genic_mule."_genic_non_auto_AA_te_cov";
open(OUTPUT4,">$output4");
my $output5 = $genic_mule."_nongenic_non_auto_AA_te_cov";

open(OUTPUT5,">$output5");
my $output6 = $genic_mule."_genic_non_auto_BB_all_te_cov";

open(OUTPUT6,">$output6");
my $output7 = $genic_mule."_nongenic_non_auto_BB_all_te_cov";
