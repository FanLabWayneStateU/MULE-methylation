...
#my $random_coor1 = "MULE_gene/data/niva_internal_MULE_c_coor_promoter_new";
...
#my $genelist = "MULE_gene/data/pack_MULE_candidate_niva_jiang_repeatscout_new_tir_final5_new_no_transposase_e9_coor_involved_exon30_gff_CDS_genic_mRNA";
...
my $q_old_chr = $chr;
open(OUTPUT3,">scaffold_old_promoter");
print OUTPUT3 ">$q_old_chr\n$seq_hash{$q_old_chr}\n";

my $q_old_str="$info[6]";
`/wsu/apps/gnu-4.4.7/perl/perl-5.20.1/bin/perl epigene/scripts/38extract_seq.pl scaffold_old_promoter $q_old_start $q_old_end $q_old_str > q_old_seq0_promoter`;
open(INPUT1,"q_old_seq0_promoter");
my $line1 = <INPUT1>;
chomp $line1;
